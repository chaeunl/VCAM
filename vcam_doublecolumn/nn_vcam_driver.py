...
class NNVcamDriver():
    ...
    def run(self): #run whole vcam process.
        ...
        self.test_vref_shift(neuron_lists)
    ...
    def run_sbias_tuning(self, neuron_lists):
        ...
        #voltage_lists = np.arange(1.08, 1.10, 0.002).tolist()
        voltage_lists = np.arange(1.08, 1.10, 0.002).tolist()
    ...
    def perform_vref_bias_shift(self, neuron_lists, voltage_lists, n_batch_tuning=1):
        ...
        #coarse tune
        for sh in range(2, -3, -1): #original: 5, 4, 3, ... -3.
    ...
    def test_vref_shift(self, neuron_lists):
        ...
        voltage_lists = np.arange(V0-0.011, V0+0.011, 0.002).tolist()
