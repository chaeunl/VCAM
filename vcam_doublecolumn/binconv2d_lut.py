...
class BinConv2d_LUT(BinConv2d):
    ...
    def forward_lut(self, input, tune=False, bias_noise_std=0.0, same_seq_through_group=False):
        ...
        if tune:
            ...
            wxn.add_( -sbias.clamp(max=0.0) ).clamp_(min=0.0, max=self.sWL)
